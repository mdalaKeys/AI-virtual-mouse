...
class HandDetector:
    ...
    def findDistance(self, p1, p2, img, draw=True):
        ...
        Args:
            p1: Index of the first point in lmList.
            p2: Index of the second point in lmList.
            img: Image on which to draw the points and line.
            draw: Boolean indicating whether to draw on the image.

        Returns:
            distance: The distance between the two points.
            img: The image with drawings (if draw is True).
            lineInfo: Information about the line and points.
        """
        x1, y1 = self.lmList[p1][0:3]
        x2, y2 = self.lmList[p2][0:3]
